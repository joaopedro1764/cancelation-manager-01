...
export function CancelationWeek() {
    ...
    // Função para obter mensagem do toast
            ...
            >
                <div className="flex items-start">
                    ...
                    <div className="ml-3 flex-1">
                        <h3 className="text-sm font-semibold" id="toast-title">
                            {message.title}
                        </h3>
                        <p className="text-sm mt-1" id="toast-description">
                            {message.message}
                        </p>
                    </div>
                    <button
    ...
    useEffect(() => {
        ...
        // Configura o intervalo de exatamente 10 segundos
        const interval = setInterval(updateValue, 3600000); // 10 segundos
            ...
            >
                <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span
                            className={`text-xs px-3 py-1 rounded-full font-medium ${cardData.colorCard}`}
                        >
